...
export default function Article(): JSX.Element {
    return (
        <div className="my-5 text-gray-500 ">
            ...
            <p className="font-bold text-lg my-3 text-black hover:underline cursor-pointer">We could not forget ixl, common lit, writing assignment that could make some sleep a half night.</p>
